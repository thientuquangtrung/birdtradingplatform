...
function AuthLayout({ children }) {
    return (
        <Stack direction="column">
            <AppBar position="sticky">
                <Toolbar sx={{ paddingTop: 1, paddingBottom: 1, justifyContent: 'space-between' }}>
                    <Stack direction="row" alignItems="center" gap={3}>
                        ...
                        <Typography variant='h6' component='h1'>Bird Trading Platform</Typography>
                        <Divider orientation="vertical" variant="middle" flexItem sx={{borderColor: 'white'}} />
                        <Typography variant='h6' component='h1'>Welcome</Typography>
                    </Stack>
            ...
            <Typography variant="subtitle1" align="center" mt={5} component="p">
